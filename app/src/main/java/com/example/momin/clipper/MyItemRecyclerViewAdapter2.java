...
import com.example.momin.clipper.dummy.CouponContent.CouponItem;
...
public class MyItemRecyclerViewAdapter2 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter2.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter2(List<CouponItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
